...
export interface AsyncMultiCreatableGroupVirtualizedInfiniteDebouncedComboboxProps {
...
export function AsyncMultiCreatableGroupVirtualizedInfiniteDebouncedCombobox({
  options,
  value = [],
  onValueChange,
  onSearch,
  ...
  overscan = 5,
  debounce = 300,
}: AsyncMultiCreatableGroupVirtualizedInfiniteDebouncedComboboxProps) {
