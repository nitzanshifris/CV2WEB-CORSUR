...
export async function addPaymentMethod(userId: string, paymentMethodId: string): Promise<void> {
  try {
...
export async function getPaymentHistory(userId: string, limit: number = 10): Promise<any[]> {
  try {
