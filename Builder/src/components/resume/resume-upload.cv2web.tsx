...
import { FileInput, FileSpreadsheet, FileText, Loader2, Upload } from 'lucide-react';
import { useState } from 'react';
import { toast } from 'sonner';
import { Card } from './ui/card';
import { Input } from './ui/input';

// TODO: Create resume-parser.ts file with these exports
type ParsedResume = {
  // Define resume fields
};
...
export function ResumeUpload({ onResumeParsed }: ResumeUploadProps) {
  ...
  const handleResumeParsed = (resume: any) => {
    setParsedResume(resume);
  };

  const handleFileChange = async (
    e: React.ChangeEvent<HTMLInputElement>,
    format: (typeof supportedFormats)[0]
  ) => {
      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto">
            Upload your existing resume or enter your information manually. We'll automatically
            transform it into a professional website.
          </p>
        </motion.div>
