...
export interface AsyncMultiCreatableGroupVirtualizedInfiniteComboboxProps {
...
export function AsyncMultiCreatableGroupVirtualizedInfiniteCombobox({
  options,
  value = [],
  onValueChange,
  onSearch,
  ...
  itemHeight = 32,
  overscan = 5,
}: AsyncMultiCreatableGroupVirtualizedInfiniteComboboxProps) {
