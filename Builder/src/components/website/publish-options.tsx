...
const publishOptions = [
  {
    ...
    icon: Globe,
    features: ['Unique URL', 'Instant availability', 'No cost', 'SSL support'],
  },
  {
    name: 'Easy Sharing',
    description: 'Share your resume with employers easily',
    icon: Share2,
    features: ['Shareable link', 'Mobile-responsive', 'Print support', 'Basic analytics'],
  },
  {
    name: 'Simple Management',
    description: 'Update your content anytime without technical knowledge',
    icon: Link,
    features: ['Real-time editing', 'Auto-save', 'Version history', 'Automatic backup'],
  },
];
