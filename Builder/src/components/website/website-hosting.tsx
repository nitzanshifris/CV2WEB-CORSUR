...
import { Copy, Globe, Link, Server, Share2 } from 'lucide-react';
...
const hostingFeatures = [
  ...
  },
  {
    ...
    icon: Server,
    features: ['99.9% uptime', 'Global CDN', 'Automatic backups', 'Zero maintenance'],
  },
  {
    name: 'Easy Sharing',
    description: 'Share your CV with recruiters in seconds',
    icon: Share2,
    features: ['One-click sharing', 'Mobile-friendly', 'Print support', 'Analytics dashboard'],
  },
];
      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto">
            Your CV website is automatically hosted and ready to share. No server management
            required.
          </p>
        </motion.div>
