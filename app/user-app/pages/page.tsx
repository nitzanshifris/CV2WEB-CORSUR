      ...
      <header className="sticky top-0 z-50 w-full border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
        <div className="container flex h-14 items-center">
          <Link href="/" className="flex items-center space-x-2">
            <span className="font-bold">CV2Web</span>
          </Link>
      ...
      <section className="container flex flex-col items-center justify-center gap-4 pb-8 pt-6 md:py-10">
        <div className="mx-auto flex max-w-[980px] flex-col items-center gap-2 text-center">
          ...
          <p className="max-w-[750px] text-lg text-muted-foreground sm:text-xl">
            Create a stunning online presence from your CV in minutes. Stand out from the crowd with a
...
const features = [
  {
    title: 'Easy to Use',
    description: 'Upload your CV and watch it transform into a beautiful website in minutes.',
  ...
  },
  {
    ...
    description: 'Choose from a variety of modern, professionally designed templates.',
    icon: function Icon(props: React.ComponentProps<'svg'>) {
      return (
        <svg
          {...props}
